<?php /* Smarty version Smarty-3.1.20, created on 2014-10-14 17:51:15
...
<head>
<meta charset="utf-8">
<title><?php if ($_smarty_tpl->tpl_vars['week']->value==1) {?>微信公众号文章周排行-<?php echo date("m月d日",$_smarty_tpl->tpl_vars['datesp']->value);?>
-<?php echo date("m月d日",$_smarty_tpl->tpl_vars['datesn']->value);?>
<?php } else { ?>微信公众号文章排行榜-<?php echo date("Y年m月d日",strtotime($_smarty_tpl->tpl_vars['dates']->value));?>
<?php }?></title>
<style>
...
<body>
<h2><?php if ($_smarty_tpl->tpl_vars['week']->value==1) {?>微信公众号文章周排行-<?php echo date("m月d日",$_smarty_tpl->tpl_vars['datesp']->value);?>
-<?php echo date("m月d日",$_smarty_tpl->tpl_vars['datesn']->value);?>
<?php } else { ?>微信公众号文章排行榜-<?php echo date("Y年m月d日",strtotime($_smarty_tpl->tpl_vars['dates']->value));?>
<?php }?></h2>
...
" target='_blank'><?php echo $_smarty_tpl->tpl_vars['v']->value['wztitle'];?>
				...
				<td><?php echo floor($_smarty_tpl->tpl_vars['v']->value['wzsuports']/$_smarty_tpl->tpl_vars['v']->value['wzreads']*10000)/10000*100;?>
%</td>
			</tr>
