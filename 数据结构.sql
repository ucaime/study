...
--
-- Host: localhost
-- Generation Time: 2014-09-20 16:18:27
-- 服务器版本： 5.6.19
-- PHP Version: 5.5.14
...
-- Database: `wx_reads`
--
CREATE DATABASE IF NOT EXISTS `wx_reads` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `wx_reads`;
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='文章信息表' AUTO_INCREMENT=238 ;
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='公账号信息表' AUTO_INCREMENT=35 ;
...
`id` int(11) NOT NULL COMMENT '主键id',
  ...
  `ctime` int(11) NOT NULL DEFAULT '0' COMMENT '创建时间',
  `cname` varchar(45) NOT NULL DEFAULT '' COMMENT '创建人'
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='微信公众号类型表' AUTO_INCREMENT=4 ;
...
ALTER TABLE `wx_pinfo`
 ADD PRIMARY KEY (`id`), ADD UNIQUE KEY `id_UNIQUE` (`id`), ADD KEY `tid` (`tid`);
...
--
ALTER TABLE `wx_article`
MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '主键id',AUTO_INCREMENT=238;
--
